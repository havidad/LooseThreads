...
import com.hypoxiagames.marioclone.entities.Entity;

/** Functions that are useful for collision detection.
 * @author Rod */
public final class Colliders {

	public static interface RemovalHandler<T extends Entity> {
		void onRemove (T t);
	}

	public static interface ColliderHandler<T extends Entity, U extends Entity> {
		void onCollision (T t, U u);
	}

	public static interface SceneryHandler<T extends Entity> {
	...
	public static <V extends Entity, W extends Entity, T extends V, U extends W> void collide (T a, U b,
	...
	public static <V extends Entity, W extends Entity, T extends V, U extends W> void collide (T go, Array<U> gos,
		ColliderHandler<V, W> callback) {
	...
	public static <U extends Entity, T extends U> void collide (Array<T> a, ColliderHandler<U, U> callback) {
	...
	public static <V extends Entity, W extends Entity, T extends V, U extends W> void collide (Array<T> a, Array<U> b,
		ColliderHandler<V, W> callback) {
		if (a != b) {
			for (int i = a.size - 1; i >= 0; i--) {
				T go = a.get(i);
	...
	public static <U extends Entity, T extends U> void collide (Array<T> gos, Array<Rectangle> rects,
	...
	public static <U extends Entity, T extends U> void collide (T go, Array<Rectangle> rects, SceneryHandler<U> callback) {
	...
	public static <T extends Entity, U extends T> void removeMarkedCollisions (Pool<U> pool, Array<U> gos,
	...
	public static <T extends Entity> void removeOutOfBounds (Pool<T> pool, Array<T> gos, Rectangle bounds) {
		float minX = bounds.x;
